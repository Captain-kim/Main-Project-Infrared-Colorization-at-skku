...
from runner import Pix2pixHDWGAN_Trainer, Pix2pixHDCustom_Trainer, Pix2pixHDfinal_Trainer, beta_Trainer
from datasets import load_dataset
from utils import load_model, load_model_custom
...
def main(args):
    ...
    # elif 'WGAN' in args.net:
        ...
        run = Pix2pixHDWGAN_Trainer(args, method, True, criterion=args.loss)
